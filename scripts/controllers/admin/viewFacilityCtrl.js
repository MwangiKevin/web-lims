app.controller('viewFacilityCtrl',
	[
	'$stateParams',
    '$state',
    '$scope',
    ...
    $scope.populateFacility_details = function() { // fetch facility details
        if ($stateParams.id > 0) {
            ...
            loaded_facility.get().then(function(facility_load) {
               ...
               if($scope.facility_detail.devices.facility_rollout_status == 1){
                    $scope.facility_detail.devices.facility_rollout_status = 'Yes';
               }else{
                    $scope.facility_detail.devices.facility_rollout_status = 'No';
               }
