...
<div class="ui segment">
  <h3><center><div class="ui pink horizontal label big"> New CD4 Device </div>(Fields marked with <i class="asterisk red icon"></i> are Required)</center></h3>
</div>

<div class="ui segment">
<form class="ui form" id="new_cd4">
		<div class="ui stackable grid">
			<div class="ui pink horizontal label big">Device Details</div><div class="field"></div>
			<div class="two fields">
		        <div class="field">
		        	<div class="ui horizontal label large">Device Serial Number <i class="asterisk red icon"></i></div><div class="field"></div>
		          	<input type="text" id="serial" ng-model="facility_dev_detail.serial_number">
		        </div>
		        <div class="field">
		        	<div class="ui horizontal label large">Device Type <i class="asterisk red icon"></i></div><div class="field"></div>
	    	...
	    	<div class="two fields">
			    ...
			    <div class="field">
		        	<!-- <div class="ui horizontal label large">Roll Out Date</div><div class="field"></div>
			      	...
			      	<div class="ui horizontal label large">Roll Out Device ? (Tick to roll out / Untick to not roll out device) <i class="asterisk red icon"></i></div><div class="field"></div>
			...
			<div class="two fields">
			    <div class="field">
		      		<div class="ui horizontal label large" id="der" ng-show="deact_reason" >Deactivation Reason <i class="asterisk red icon"></i></div><div class="field"></div>
