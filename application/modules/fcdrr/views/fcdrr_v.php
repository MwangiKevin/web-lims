...
<h2>FACILITY CONSUMPTION DATA REPORT & REQUEST(F-CDRR) FOR ART LABORATORY MONITORING REAGENTS</h2>
	...
	<div class="four wide column">Facility: </div>
      ...
      <table  class="ui celled structured table">
		  <thead>
		    <tr>
				...
				<th colspan="2">Adjustments<br/><i>Inhicate if (+) or (-)</i></th>
		  ...
		  <tbody>
		    <tr><td rowspan="1" colspan="10" style="border:1px solid black !important;background:#eeeeee;">FACS Calibur reagents and consumables</td></tr>	
					<tr ng-repeat="user in users.facs_calibur">
						<td>{{user.name}}</td>
						<td>{{user.unit}}</td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" required/></div></td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" required/></div></td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" required/></div></td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" required/></div></td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" required/></div></td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" required/></div></td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" value="" required readonly/></div></td>
						<td><div class="ui input"><input name="" id="" style="width:100px;" size="5" type="text" class="form-control" required/></td>
					</tr>
		  </tbody>
	</table>
	<hr />
