DROP PROCEDURE IF EXISTS `proc_test_n_errors_summarized_report`;

CREATE PROCEDURE proc_test_n_errors_summarized_report(user_group_id int(11), user_filter_used int(11), date_from date, date_to date)
BEGIN
