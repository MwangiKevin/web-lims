DROP PROCEDURE IF EXISTS `proc_tests_detailed_report`;

CREATE PROCEDURE proc_tests_detailed_report(user_group_id int(11), user_filter_used int(11), date_from date, date_to date)
BEGIN
