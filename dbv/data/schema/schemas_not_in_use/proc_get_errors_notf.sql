DROP PROCEDURE IF EXISTS `proc_get_errors_notf`;

CREATE PROCEDURE proc_get_errors_notf(from_date date,to_date date,user_group_id int(11),user_filter_used int(11))
	BEGIN
